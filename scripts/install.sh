...
UPDATER_SECRET="${UPDATER_SECRET:-$(rand_secret 32)}"
ENCRYPTION_KEY="${ENCRYPTION_KEY:-$(openssl rand -hex 32)}"

# ── derived values ──────────────────────────────────────────────────────────

CORS_ORIGIN="https://${DOMAIN}"
ECHOLORE_PUBLIC_API_URL="https://${DOMAIN}"
ECHOLORE_PUBLIC_LIVEKIT_URL="wss://${DOMAIN}"
...
ECHOLORE_PUBLIC_API_URL=${ECHOLORE_PUBLIC_API_URL}
ECHOLORE_PUBLIC_LIVEKIT_URL=${ECHOLORE_PUBLIC_LIVEKIT_URL}
