...
export function createAiChatAgent(
  ...
  const systemMessage = [
    ...
    "4. **Drive-based questions**: The retrieved context above may include both Wiki and Drive sources. If you need more Drive content, use `drive_search` for additional queries or `drive_read` for full file content.",
    "",
    "## Guidelines",
