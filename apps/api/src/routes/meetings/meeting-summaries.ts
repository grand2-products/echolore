...
meetingSummaryRoutes.post("/:id/summaries", zValidator("json", createSummarySchema), withErrorHandler(async (c) => {
...
}, "MEETING_SUMMARY_CREATE_FAILED", "Failed to add summary"));
