...
meetingPipelineRoutes.post("/:id/pipeline/run", zValidator("json", runPipelineSchema), withErrorHandler(async (c) => {
...
}, "MEETING_PIPELINE_RUN_FAILED", "Failed to run room AI pipeline"));
