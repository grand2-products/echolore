...
wikiRevisionRoutes.get("/:id/revisions", withErrorHandler(async (c) => {
...
}, "WIKI_REVISIONS_LIST_FAILED", "Failed to list revisions"));

wikiRevisionRoutes.get("/:id/revisions/:revisionId", withErrorHandler(async (c) => {
...
}, "WIKI_REVISION_FETCH_FAILED", "Failed to fetch revision"));
...
wikiRevisionRoutes.post("/:id/revisions", async (c) => {
  ...
  }, "WIKI_REVISION_CREATE_FAILED", "Failed to create revision")(c);
});
...
wikiRevisionRoutes.post("/:id/revisions/:revisionId/restore", async (c) => {
  ...
  }, "WIKI_REVISION_RESTORE_FAILED", "Failed to restore revision")(c);
});
