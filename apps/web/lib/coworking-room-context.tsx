...
export function CoworkingRoomProvider({ children }: { children: ReactNode }) {
    ...
    async (opts?: JoinOptions) => {
      ...
      try {
        ...
        const newRoom = new Room({
          ...
          adaptiveStream: isMcu ? false : adaptiveStream ? { pixelDensity: "screen" } : false,
  ...
  return <CoworkingRoomContext.Provider value={value}>{children}</CoworkingRoomContext.Provider>;
}
